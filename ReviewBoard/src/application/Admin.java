...
public class Admin extends User{
	...
	public static void addRestaurant(String rest_name, String specialization, String location) {
		try {
	         ...
	         opinion.setTextContent("none");
	         rest.appendChild(opinion);
	        	 ...
	        	 if (node.getNodeType() == Node.ELEMENT_NODE) {
	                 ...
	                 if (restaurant.equals(eElement.getElementsByTagName("name").item(0).getTextContent())) {
	                        ...
	                        if (good > okay & good > bad) {
	           	        	 eElement.getElementsByTagName("opinion").item(0).setTextContent("positive");
	           	         }
	           	         if (okay > good & okay > bad) {
	           	        	eElement.getElementsByTagName("opinion").item(0).setTextContent("okay");
	           	         }
	           	         if (bad > good & bad > okay) {
	           	        	eElement.getElementsByTagName("opinion").item(0).setTextContent("negative");
	           	         }
